 ...
 * Mollie payment + the Propeller payment (status OPEN + AUTHORIZATION txn) and
 * returns the Mollie hosted-checkout URL for the client to redirect to.
 *
 * Contract:
 ...
 *     method: string,            // Propeller method code (mapped to Mollie)
 *     description: string,
 *     redirectUrl: string,       // where Mollie returns the shopper
 *     userId?: number,
 *     anonymousId?: number
 *   }
 *
