...
import { useCheckout } from '@propeller-commerce/propeller-v2-react-ui';
import { restoreManagerCart } from '@/utils/cartHelpers';
import { CartPaymethods } from '@propeller-commerce/propeller-v2-react-ui';
import { AddressSelector } from '@propeller-commerce/propeller-v2-react-ui';
import { CartCarriers } from '@propeller-commerce/propeller-v2-react-ui';
import { DeliveryDate } from '@propeller-commerce/propeller-v2-react-ui';
import { CartOverview } from '@propeller-commerce/propeller-v2-react-ui';
import { ItemsOverview } from '@propeller-commerce/propeller-v2-react-ui';
...
// component body and calls this during render, so a `const`
...
function CheckoutPageInner() {
  ...
  // method's — the totals used to only refresh on Continue, which made
...
// inside) each time the page re-renders.
