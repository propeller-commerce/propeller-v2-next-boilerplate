...
export interface ApiCategoryBannerCategoryBanner extends Struct.CollectionTypeSchema {
  collectionName: 'category_banners';
  info: {
    description: 'Banner images linked to Propeller category IDs';
  ...
  attributes: {
    categoryId: Schema.Attribute.String & Schema.Attribute.Required & Schema.Attribute.Unique;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> & Schema.Attribute.Private;
    ...
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::category-banner.category-banner'> &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiGlobalGlobal extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'Define global settings for header, footer and SEO';
    displayName: 'Global';
    pluralName: 'globals';
    singularName: 'global';
  };
  ...
  attributes: {
    availableLanguages: Schema.Attribute.String & Schema.Attribute.DefaultTo<'EN,NL'>;
    categoriesMenuLabel: Schema.Attribute.String & Schema.Attribute.DefaultTo<'Browse Categories'>;
    ...
    logoAlt: Schema.Attribute.String & Schema.Attribute.DefaultTo<'Logo'>;
    navLinks: Schema.Attribute.Component<'shared.nav-link', true>;
    publishedAt: Schema.Attribute.DateTime;
    showAccount: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<true>;
    showCart: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<true>;
    showCategoriesMenu: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<true>;
    showLanguageSwitcher: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<true>;
    showSearch: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<true>;
    showVatToggle: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<true>;
    siteDescription: Schema.Attribute.Text & Schema.Attribute.Required;
    siteName: Schema.Attribute.String & Schema.Attribute.Required;
    topBarAnnouncement: Schema.Attribute.String;
    topBarAnnouncementEnabled: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    topBarEnabled: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<true>;
    topBarPhone: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> & Schema.Attribute.Private;
  };
}
...
export interface ApiPagePage extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    template: Schema.Attribute.Enumeration<['default', 'landing-page', 'editorial']> &
