...
export interface ApiGlobalGlobal extends Struct.SingleTypeSchema {
  ...
  attributes: {
    availableLanguages: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'EN,NL'>;
    categoriesMenuLabel: Schema.Attribute.String &
    ...
    showCategoriesMenu: Schema.Attribute.Boolean &
    ...
    topBarAnnouncementEnabled: Schema.Attribute.Boolean &
      Schema.Attribute.DefaultTo<false>;
...
export interface ApiPagePage extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    template: Schema.Attribute.Enumeration<
      ['default', 'landing-page', 'editorial']
    > &
