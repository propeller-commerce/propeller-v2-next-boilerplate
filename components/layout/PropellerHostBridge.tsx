...
export default function PropellerHostBridge({
   ...
   * the channel's assortment rules, negative order lists included.
   */
  ...
  // shop that lets the channel decide (the intended default).
  ...
  // here; this is the client-side half of the "no module guesses a
  // catalog root".
  //
  ...
  return (
    <PropellerDepsProvider value={deps}>
      <PropellerProvider value={scope}>
        {/* Behaviour tracking: syncs scope into the tracker singleton
