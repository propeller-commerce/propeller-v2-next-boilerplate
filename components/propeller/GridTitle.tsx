...
<div  className={`mb-8 ${props.className as string || ''}`}><div className="flex items-baseline gap-3 mb-3">{props.headingLevel as string === 'h2' ? (
<h2 className="text-3xl sm:text-4xl font-bold tracking-tight">{props.title}</h2>
) : null}{props.headingLevel as string !== 'h2' ? (
