...
const EMAIL = process.env.TEST_CUSTOMER_USERNAME || process.env.E2E_CUSTOMER_EMAIL || '';
const PASSWORD = process.env.TEST_CUSTOMER_PASSWORD || process.env.E2E_CUSTOMER_PASSWORD || '';
if (!EMAIL || !PASSWORD) {
  throw new Error(
