...
function GridToolbar(props: GridToolbarProps) {
  const [currentSortField, setCurrentSortField] = useState<
    GridToolbarState["currentSortField"]
  >(() => Enums.ProductSortField.CATEGORY_ORDER);

  const [currentSortOrder, setCurrentSortOrder] = useState<
    GridToolbarState["currentSortOrder"]
  >(() => Enums.SortOrder.ASC);

  const [currentOffset, setCurrentOffset] = useState<
    GridToolbarState["currentOffset"]
  >(() => 12);

  const [currentViewMode, setCurrentViewMode] = useState<
    GridToolbarState["currentViewMode"]
  >(() => "grid");
  ...
  function getOffsetOptions(): ReturnType<
    GridToolbarState["getOffsetOptions"]
  > {
  ...
  function hasActiveFilters(): ReturnType<
    GridToolbarState["hasActiveFilters"]
  > {
  ...
  function handleViewChange(): ReturnType<
    GridToolbarState["handleViewChange"]
  > {
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-4">
        ...
        <div className="flex flex-wrap items-center gap-3">
          ...
          <select
            ...
            onChange={(e) =>
              handleSortFieldChange((e.target as HTMLSelectElement).value)
            }
          >
          ...
          <select
            ...
            onChange={(e) =>
              handleSortOrderChange((e.target as HTMLSelectElement).value)
            }
          >
