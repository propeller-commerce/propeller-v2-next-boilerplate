...
try {
  ...
  const result = await service.getCategory({
    ...
    categoryProductSearchInput: {
      ...
      ...(props.user && {
        userId: 'contactId' in props.user ? (props.user as Contact)?.contactId : (props.user as Customer)?.customerId
      }),
      ...
      ...((props.sortField || currentSortField.value) && {
        sortInputs: [{
          field: (props.sortField as string || currentSortField.value) as Enums.ProductSortField,
  ...
  itemsFound.value = adjustedTotal;
