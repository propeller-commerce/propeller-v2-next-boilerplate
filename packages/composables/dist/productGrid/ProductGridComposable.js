...
exports.createProductGridComposable = createProductGridComposable;
const ComposableStore_1 = require("../core/ComposableStore");
const productGridLogic_1 = require("./productGridLogic");
const INITIAL_STATE = {
    items: [],
    currentPage: 1,
    totalPages: 1,
 ...
 */
function createProductGridComposable(config) {
    ...
    async function doFetch(query) {
        ...
        try {
            ...
            const result = await (0, productGridLogic_1.fetchProducts)(config, query, state.currentSortField, state.currentSortOrder);
...
//# sourceMappingURL=ProductGridComposable.js.map