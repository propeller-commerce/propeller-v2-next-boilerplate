import type { GraphQLClient, Product, Cluster, Contact, Customer, AttributeFilter, ProductTextFilterInput, ProductsResponse, Category, MediaImageProductSearchInput, TransformationsInput } from 'propeller-sdk-v2';
