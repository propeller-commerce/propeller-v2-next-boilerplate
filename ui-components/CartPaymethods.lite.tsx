                    ...
                    <For each={state.payMethods}>
                        {(method: CartPaymethod, index: number) => (
                            <div
                                ...
                                className={`cursor-pointer border border-gray-200 rounded-lg p-4 flex flex-col gap-2 transition-all ${state.selectedCode === method.code ? 'border-secondary bg-secondary/5 shadow-sm' : 'hover:border-secondary/30'}`}
                            >
