    ...
    const state = useStore<ProductBulkPricesState>({
        ...
        getBulkPrices(): ProductPrice[] {
            ...
            const all = rawAll.filter((tier) => {
                const t = tier as ProductPrice & { type?: string; discountType?: string };
                const priceType = t.type ?? (t.discount as { type?: string } | undefined)?.type;
                const discountType = t.discountType ?? (t.discount as { discountType?: string } | undefined)?.discountType;
