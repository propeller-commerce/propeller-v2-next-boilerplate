...
export default function ProductGrid(props: ProductGridProps) {
    const state = useStore<ProductGridState>({
        internalProducts: [],
            ...
            try {
                ...
                const result = await service.getCategory({
                    ...
                    categoryProductSearchInput: {
                        ...
                        ...((props.sortField || state.currentSortField) && {
                            sortInputs: [{
                                field: ((props.sortField as string) || state.currentSortField) as Enums.ProductSortField,
                                order: ((props.sortOrder as string) || state.currentSortOrder) as Enums.SortOrder,
                            }],
                        }),
        ...
        getIsLoading(): boolean {
            return !!(props.isLoading as boolean) || state.isInternalLoading;
        },
